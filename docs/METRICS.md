...
Метрики автоматически попадают в Elasticsearch при использовании JSON-формата логов. Можно создавать дашборды в Kibana для визуализации.

### Grafana

Метрики можно визуализировать в Grafana, подключив источник данных (Prometheus, Elasticsearch или напрямую из логов).
